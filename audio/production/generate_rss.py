...
Usage:
  ...
  python audio/production/generate_rss.py --base-url https://example.com --dry-run
...
from audio.paths import PRODUCTION_AUDIO_DIR, RSS_OUTPUT_DIR

AUDIO_DIR = PRODUCTION_AUDIO_DIR
...
def main():
    ...
    ap.add_argument("--output", default=str(RSS_OUTPUT_DIR / "podcast.xml"))
    ...
    if not episodes:
        sys.exit("No audio files found. Generate audio first with audio/production/generate.py.")
